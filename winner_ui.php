...
<head>
    ...
    <style>
        ...
        #title {
            ...
            letter-spacing: 4px;
            animation: titleJackpot 2s infinite alternate;
        }
        ...
        #weight-container {
            ...
            position: relative;
            border-color: #ffe866;
            animation: slotWin 1.8s infinite;
        }
...
<body>
    <!-- Hidden video source for chroma-key background -->
    <video id="bg-video" src="assets/gold-coins.mp4" autoplay loop muted playsinline style="display:none;"></video>
    <!-- Background canvas: renders video with green-screen removed -->
    ...
    <div><img style="position: absolute; bottom: 0; left: 0; width: 100vw; height: auto;" src="./assets/chest-coins.png"
            alt=""></div>
