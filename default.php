...
<head>
    ...
    <title>Gold For Cash - Default</title>
    <style>
...
<body>
    ...
    <div><img class="chest-coins" style="position: absolute; bottom: 0; left: 0;" src="./assets/chest-coins.png" alt="">
    </div>
    ...
    <script>
        ...
        function animateDust() {
            ...
            ambientDust.forEach(p => {
                ...
                ctx.beginPath();
                ctx.arc(p.x, p.y, p.r, 0, Math.PI * 6);
